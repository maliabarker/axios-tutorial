// AXIOS GLOBALS
// creating custom token for auth
...
// PUT/PATCH REQUEST
function updateTodo() {
// PUT REQUEST — replaces entire point of data
    // LONGER METHOD
    // axios({
    //     method: 'put',
...
// PATCH REQUEST—edits changes to already existing data point
    // LONGER METHOD
    // axios({
    //     method: 'patch',
    //     url: 'https://jsonplaceholder.typicode.com/todos/1',
...
// Allows you to transform/change data or response
...
function errorHandling() {
    ...
    .get('https://jsonplaceholder.typicode.com/todoss', {
        // limits the catch error to a certain status
...
// commented out because will run right away
